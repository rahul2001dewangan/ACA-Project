...
/* RRIP specific constants */
#define RRIP_MAX 3		/* Maximum RRPV value for SRRIP */
#define RRIP_NEAR_IMP 0		/* Near-immediate re-reference */
#define RRIP_LONG 2		/* Long re-reference interval */
#define RRIP_DISTANT 3		/* Distant re-reference */
...
struct cache_blk_t
{
  ...
  unsigned char rrpv;		/* RRIP: Re-Reference Prediction Value */
